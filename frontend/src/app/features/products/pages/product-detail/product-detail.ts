...
export class ProductDetail implements OnInit {
  ...
  private apiUrl = `${environment.apiUrl}/api`; // Backend base URL
  ...
  setRating(value: number): void { this.newRating = value; } // Set rating
  setHover(value: number): void { this.hoverRating = value; } // Hover rating
  clearHover(): void { this.hoverRating = 0; } // Reset hover
  ...
  addToCart(): void {
    ...
    this.toast.show(`${this.product.name} added to cart`, 'success'); // Toast feedback
  }

  getStars(rating: number): string[] {
    const stars = []; // Star state array
